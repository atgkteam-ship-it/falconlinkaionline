      ...
      <div className="grid-bg relative flex min-h-[calc(100vh-65px)] items-center justify-center px-4 py-10">
        <div className="w-full max-w-md">
          <div className="glass-strong rounded-3xl p-8 shadow-glow">
            ...
            <Button type="button" variant="outline" className="w-full h-11 rounded-xl" onClick={() => handleOAuth("google")}>
            ...
            <Button type="button" variant="outline" className="mt-2 w-full h-11 rounded-xl bg-black text-white hover:bg-black/90 hover:text-white border-black" onClick={() => handleOAuth("apple")}>
              <svg className="mr-2 h-4 w-4" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 12.04c-.03-2.92 2.39-4.32 2.5-4.39-1.36-1.99-3.49-2.27-4.25-2.3-1.81-.18-3.53 1.07-4.45 1.07-.92 0-2.34-1.04-3.85-1.01-1.98.03-3.81 1.15-4.83 2.93-2.06 3.57-.53 8.85 1.49 11.75.99 1.42 2.16 3.01 3.7 2.95 1.49-.06 2.05-.96 3.85-.96 1.8 0 2.31.96 3.88.93 1.6-.03 2.62-1.45 3.6-2.87 1.13-1.65 1.6-3.25 1.62-3.33-.04-.02-3.11-1.19-3.14-4.72zM14.13 3.62c.81-.99 1.36-2.36 1.21-3.72-1.17.05-2.59.78-3.43 1.76-.75.87-1.41 2.27-1.23 3.6 1.31.1 2.64-.66 3.45-1.64z"/></svg>
              Continue with Apple
            </Button>
